...
class ProductHallAdmin(BaseModelViewWithFilters, model=ProductHall):
    ...
    column_list = [
        ...
        ProductHall.contain_pyebaek_room,
        ProductHall.contain_family_waiting_room,
    ...
    column_labels = {
        ...
        ProductHall.contain_pyebaek_room: "폐백실 여부",
        ProductHall.contain_family_waiting_room: "혼주 대기실 여부",
